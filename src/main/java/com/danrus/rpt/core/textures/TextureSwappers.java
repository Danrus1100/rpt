...
public class TextureSwappers {
    public static final ExtraCodecs.LateBoundIdMapper<ResourceLocation, MapCodec<? extends TextureSwapper.Unbaked>> ID_MAPPER = new ExtraCodecs.LateBoundIdMapper<>();
    public static final Codec<TextureSwapper.Unbaked> CODEC = ID_MAPPER.codec(ResourceLocation.CODEC).dispatch(TextureSwapper.Unbaked::type, mapCodec -> mapCodec);
